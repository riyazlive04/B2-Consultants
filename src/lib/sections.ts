...
export const SECTION_CATALOGUE = [
  ...
  { key: "pipeline", label: "Pipeline", href: "/pipeline", phase: 1, icon: "git-branch", group: "Money", roles: ["ADMIN", "USER"] },
  ...
  { key: "cv-check", label: "CV Diagnostic", href: "/cv-check", phase: 2, icon: "file-search", group: "Insights", roles: ["ADMIN", "HEAD", "STUDENT"] },
