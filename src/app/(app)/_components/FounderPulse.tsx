    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      ...
      >
        ...
        <div className="relative mt-5 grid grid-cols-3 gap-3">
          {heroTiles.map((t) => (
            <div key={t.label} className="rounded-2xl bg-white/10 px-3 py-2.5 backdrop-blur">
          ...
          <div className="relative mt-3 grid grid-cols-2 gap-2.5">
            {weekStats.map((s) => (
              <Link
                key={s.label}
                href="/pipeline"
                className="rounded-2xl bg-white/10 px-3 py-2.5 transition-colors hover:bg-white/20"
              >
