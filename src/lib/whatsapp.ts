...
export const WHATSAPP_KIND_LABELS: Record<WhatsAppKind, string> = {
  ...
  SOP_SSS_CONFIRM_3: "SOP 20b · SSS confirmation 3",
  SOP_DISCO_NOSHOW: "L2 · Discovery call missed",
  SOP_FOLLOWUP_2: "SOP 7b · Second follow-up, still not booked",
  SOP_NOT_QUALIFIED: "SOP 13c · Not qualified, call released",
...
export const WHATSAPP_KIND_HINTS: Record<WhatsAppKind, string> = {
  ...
  SOP_FOLLOWUP: "Outreach SOP Step 6 - still not booked at the first booking check.",
  SOP_SSS_CONFIRM_3: "Outreach SOP Step 20b - 6h before the SSS call, no reply to the 24h or 12h reminders.",
  SOP_DISCO_NOSHOW: "Level 2 - the prospect did not join their discovery call and two call attempts failed.",
  SOP_FOLLOWUP_2: "Outreach SOP Step 7b - still not booked at the second booking check.",
  SOP_NOT_QUALIFIED: "Outreach SOP Step 13c - BANT below the bar; the booked call is released. NEEDS AN APPROVED WATI TEMPLATE before it can send - until one is bound here the step waits in the queue.",
...
export const WHATSAPP_AVAILABLE_VARS: Record<WhatsAppKind, readonly string[]> = {
  ...
  SOP_SSS_CONFIRM_3: ["name", "date", "time", "zoom_link"],
  SOP_DISCO_NOSHOW: ["name"],
  SOP_FOLLOWUP_2: ["name", "sender"],
  SOP_NOT_QUALIFIED: ["name", "sender"],
