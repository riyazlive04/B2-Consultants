...
const PUBLIC_PREFIXES = [
  ...
  // robots.txt and sitemap.xml, generated by src/app/robots.ts and src/app/sitemap.ts. A crawler
  // sends no cookie, so without this both 307 to /login - and a robots.txt that answers with an
  // HTML sign-in page is read as "no rules found", which is the opposite of what it says. Neither
  // file exposes anything: robots.txt names the four public prefixes, and the sitemap lists only
  // pages already published on a published site.
